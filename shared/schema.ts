...
export const users = pgTable("users", {
  ...
  email: text("email"), // Haciendo el correo electr??nico opcional (puede ser nulo o vac?�o)
...
export const documents = pgTable("documents", {
  ...
  category: text("category").default("general"), // ?�?????�?? ?�???�???�???�: receipt, contract, general, etc.
...
// Transaction Edit Permissions table - ?�?�?�???� ?????�?�?�?�?� ?�???�?�?? ?�???�???�?�???�?� ?�???�?�?�?�?�
export const transactionEditPermissions = pgTable("transaction_edit_permissions", {
  ...
  expiresAt: timestamp("expires_at").notNull(), // ?�???�?�?�?� ?�???????�?�?�?� (42 ???�???�)
...
export const ledgerEntries = pgTable("ledger_entries", {
  ...
  description: text("description").notNull(),
  projectId: integer("project_id").references(() => projects.id),
  entryType: text("entry_type").notNull(), // "classified" ?�?� "miscellaneous" ?�?� "deferred"
...
export const insertUserSchema = createInsertSchema(users)
  ...
  .extend({
    ...
    projectId: z.number().optional(), // ?�???�???� ?�?�?? projectId ?�?�?�???�?� ?�???�???�?� ???� ?�?�???�?�?� ?�?? ?�???�?�?�??
