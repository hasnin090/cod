-- حل مشكلة تكرار أنواع المصروفات
-- Fix duplicate expense types issue

-- حذف أنواع المصروفات المكررة مع الاحتفاظ بالأحدث
...
-- إدراج أنواع المصروفات الافتراضية بشكل آمن
